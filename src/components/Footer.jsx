...
const socialLinks = [
  ...
  { icon: IconInstagram, label: 'Instagram', href: 'https://www.instagram.com/cardbook.ecosystem/' },
];
        ...
        <div className="max-w-screen-xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-10">
            ...
            <div>
              ...
              <p className="font-mono text-[10px] tracking-widest2 uppercase text-accent/70 mb-4">
                <a
              ...
              <p className="font-sans text-base text-ink-300 max-w-xs">{t('footer.tagline')}</p>
            </div>
